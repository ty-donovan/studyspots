...
class newLocationForm(forms.Form):
    ...
    locationName = forms.CharField(label='Name of Location', max_length=100, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    spotName = forms.CharField(label='Name of Spot', max_length=100, widget=forms.TextInput(attrs={'class': 'form-control'}))
    capacity = forms.IntegerField(label='Capacity', widget=forms.NumberInput(attrs={'class': 'form-control'}), max_value=1000)
